...
const METHOD_MAP = {
  ...
  // TODO: Reshy!!!!
  '/session/:sessionId/appium/device/a_adb_exec': {
    POST: {command: 'aAdbExec', payloadParams: {required: ['cmd'], optional: ['opts']}}
  },
  // Reshy!!
  '/session/:sessionId/appium/device/reap_action': {
    POST: {command: 'reapAction', payloadParams: {required: ['actions']}}
  },
  '/session/:sessionId/appium/device/a_adb_shell': {
    POST: {command: 'aAdbShell', payloadParams: {required: ['cmd'], optional: ['opts']}}
  },
